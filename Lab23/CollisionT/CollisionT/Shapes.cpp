...
Bolt::Bolt()
{
    ...
    Point boltVertex[1][8] =
    {
        { Point(40 - 40, 8 - 60), Point(84 - 40, 8 - 60), Point(54 - 40, 40 - 60), Point(78 - 40, 40 - 60), Point(28 - 40, 97 - 60), Point(39 - 40, 53 - 60), Point(21 - 40, 53 - 60), Point(40 - 40, 8 - 60)},
    };


    // cria bounding box
    BBox(new Poly(boltVertex[0], 8));
    MoveTo(726, 380);
    type = BOLT;
}
